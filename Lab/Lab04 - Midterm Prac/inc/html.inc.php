...
function htmlRoster($rosterData)    {
  ...
  foreach($rosterData as $roster){
   ...
   echo '<tr>'
          . '<th> Logo </th>'
          . '<th ><a href="./Lab04JPa_81074.php?sort=teamName"> Team </a></th>'
          . '<th ><a href="./Lab04JPa_81074.php?sort=payroll"> Payroll </a></th>'
          . '<th ><a href="./Lab04JPa_81074.php?sort=win"> Wins </a></th>'
        . '</tr>';
